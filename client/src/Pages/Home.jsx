...
export default function Home() {
  ...
  return (
    <div className="mb-0">
      ...
      <Link to={"/search"}>
        <div className="flex justify-center  drop-shadow-2xl rounded-lg m-10 p-10 ">
      ...
      >
        {loading ? (
          ...
          <div className="text-white text-2xl overflow-auto font-bold shadow-lg p-4 border rounded-lg h-20 ">
            NO DATA AVAILABLE
          </div>
        ) : (
          <motion.div
